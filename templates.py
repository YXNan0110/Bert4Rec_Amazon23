def set_template(args):
    if args.template is None:
        ...
        # 获取用户输入
        user_input = input("Input 1 for All_Beauty, 2 for Digital_Music, 3 for Video_Games: ")

        # 根据用户输入设置 dataset_code
        if user_input == '1':
            args.dataset_code = 'All_Beauty'
        elif user_input == '2':
            args.dataset_code = 'Digital_Music'
        elif user_input == '3':
